...
public class Course {
    ...
    private com.ucop.edu.entity.enums.CourseStatus status = com.ucop.edu.entity.enums.CourseStatus.OPEN;
    ...
    public com.ucop.edu.entity.enums.CourseStatus getStatus() {
        return status;
    }

    public void setStatus(com.ucop.edu.entity.enums.CourseStatus status) {
        this.status = status;
    }
    ...
    public SeatStock getSeatStock() {
        return seatStock;
    }

    public void setSeatStock(SeatStock seatStock) {
    ...
    public Set<EnrollmentItem> getEnrollmentItems() {
